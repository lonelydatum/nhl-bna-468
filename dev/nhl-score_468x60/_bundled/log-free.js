...
function start() {
	...
	(0, _commonJsStrikerJs.player)(1.5, { x: "-=50" });
	tl.from(".t1a", .15, { x: "-=100", opacity: 0 }, 1);
	tl.from(".t1b", .15, { x: "-=100", opacity: 0 }, 1.2);

	tl.add((0, _commonJsCommonJs.frameEnd)(), 3.1);
}
...
},{"../../_common/js/common.js":1,"../../_common/js/striker.js":3}],3:[function(require,module,exports){
"use strict";
...
var _commonJsScoreJs = require('../../_common/js/score.js');

(0, _commonJsScoreJs.start)();

module.exports = {};

},{"../../_common/js/score.js":2}]},{},[4])
